...
fetchMarkers <- function(ref,
  ...
  if (type == "brain") {
    markerGenes <- c(
      "Abat", "Abca12", "Abca13", "Abhd2", "Ablim1", "Ablim2", "Ablim3", "Acan", "Acsf3", "Adamts15", "Adcy8", "Adcyap1r1", "Adgrf5", "Adgrg4", "Adgrl2", "Adora2a", "Adra1a", "Afap1", "Aff2", "Ajap1", "Ak5", "Akap13", "Ankk1", "Ano1", "Aplnr", "Aqp4", "Arhgap15", "Arhgap22", "Arhgap25",
