...
obj@metadata$louvain_cluster <- runCluster(obj, k = 10, reduction = "irlba_ch100k_cg100k", method = "louvain") 
obj@metadata$leiden_cluster <- runCluster(obj, k = 10, reduction = "irlba_ch100k_cg100k", method = "leiden") 
```
...
dimFeature(obj, colorBy = louvain_cluster, labelBy = louvain_cluster, colors = pal, pointSize = .8, reduction = "umap_irlba_ch100k_cg100k")
```
...
dimFeature(obj, colorBy = type, labelBy = type, colors = pal, reduction = "umap_irlba_ch100k_cg100k", pointSize = .8)
```
