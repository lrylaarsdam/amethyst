...
First, you need to install and load the dependencies and functions. I am working on assembling a package, but for now, I have compiled the necessary info into a single script on Adey lab servers called amethyst_singlescript.R. You can load the functions and dependencies using the source() function. If you are using Github, you can load with devtools or run the contents of the files in the R folder in your console.
